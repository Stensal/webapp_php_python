...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000004a424496000000002656fa04(
...
class phpbbtemplatetwiglexer_000000004a424496000000002656fa04 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder59f693b3d9439277597424 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer59f693b3d9454628561156 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties59f693b3d93f7479439389 = array(
    ...
    {
        $this->initializer59f693b3d9454628561156 && $this->initializer59f693b3d9454628561156->__invoke($this->valueHolder59f693b3d9439277597424, $this, 'set_environment', array('env' => $env), $this->initializer59f693b3d9454628561156);

        return $this->valueHolder59f693b3d9439277597424->set_environment($env);
    }
    ...
    {
        $this->initializer59f693b3d9454628561156 && $this->initializer59f693b3d9454628561156->__invoke($this->valueHolder59f693b3d9439277597424, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer59f693b3d9454628561156);

        return $this->valueHolder59f693b3d9439277597424->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer59f693b3d9454628561156 && $this->initializer59f693b3d9454628561156->__invoke($this->valueHolder59f693b3d9439277597424, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer59f693b3d9454628561156);

        return $this->valueHolder59f693b3d9439277597424->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer59f693b3d9454628561156 = $initializer;
    }
    ...
    {
        $this->initializer59f693b3d9454628561156 && $this->initializer59f693b3d9454628561156->__invoke($this->valueHolder59f693b3d9439277597424, $this, '__get', array('name' => $name), $this->initializer59f693b3d9454628561156);

        if (isset(self::$publicProperties59f693b3d93f7479439389[$name])) {
            return $this->valueHolder59f693b3d9439277597424->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59f693b3d9439277597424;
    ...
    {
        $this->initializer59f693b3d9454628561156 && $this->initializer59f693b3d9454628561156->__invoke($this->valueHolder59f693b3d9439277597424, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer59f693b3d9454628561156);
    ...
    {
        $this->initializer59f693b3d9454628561156 && $this->initializer59f693b3d9454628561156->__invoke($this->valueHolder59f693b3d9439277597424, $this, '__isset', array('name' => $name), $this->initializer59f693b3d9454628561156);
    ...
    {
        $this->initializer59f693b3d9454628561156 && $this->initializer59f693b3d9454628561156->__invoke($this->valueHolder59f693b3d9439277597424, $this, '__unset', array('name' => $name), $this->initializer59f693b3d9454628561156);
    ...
    {
        $this->initializer59f693b3d9454628561156 && $this->initializer59f693b3d9454628561156->__invoke($this->valueHolder59f693b3d9439277597424, $this, '__clone', array(), $this->initializer59f693b3d9454628561156);

        $this->valueHolder59f693b3d9439277597424 = clone $this->valueHolder59f693b3d9439277597424;
    }

    public function __sleep()
    {
        $this->initializer59f693b3d9454628561156 && $this->initializer59f693b3d9454628561156->__invoke($this->valueHolder59f693b3d9439277597424, $this, '__sleep', array(), $this->initializer59f693b3d9454628561156);

        return array('valueHolder59f693b3d9439277597424');
    }
    ...
    {
        return $this->initializer59f693b3d9454628561156;
    }
    ...
    {
        return $this->initializer59f693b3d9454628561156 && $this->initializer59f693b3d9454628561156->__invoke($this->valueHolder59f693b3d9439277597424, $this, 'initializeProxy', array(), $this->initializer59f693b3d9454628561156);
    }
    ...
    {
        return null !== $this->valueHolder59f693b3d9439277597424;
    }
    ...
    {
        return $this->valueHolder59f693b3d9439277597424;
    }
