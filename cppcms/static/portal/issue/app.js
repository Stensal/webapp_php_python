...
var AniLoading = function AniLoading(props) {
...
var MarkdownHelp_1 = __webpack_require__(70);
var Showdown = __webpack_require__(89);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var ReactMdeSelectionHelper_1 = __webpack_require__(17);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var HeaderGroup_1 = __webpack_require__(66);
var HeaderItemDropdown_1 = __webpack_require__(68);
var HeaderItem_1 = __webpack_require__(67);
...
Object.defineProperty(exports, "__esModule", { value: true });
var ReactMdeTextHelper_1 = __webpack_require__(18);
/**
...
var _labelsBar = __webpack_require__(46);

var _labelsBar2 = _interopRequireDefault(_labelsBar);

var _issueNodeList = __webpack_require__(44);

var _issueNodeList2 = _interopRequireDefault(_issueNodeList);
...
var FrontPage = (0, _mobxReact.observer)(_class = function (_React$Component) {
			...
			_createClass(FrontPage, [{
						...
						value: function render() {
									...
									return React.createElement(
												'div',
												{ className: 'issue-front-page' },
												React.createElement(_labelsBar2.default, { store: store, match: match }),
												React.createElement(
															'div',
															{ className: 'container pure-g' },
															React.createElement(_issueNodeList2.default, this.props)
												)
									);
						}
			}]);
...
var _class, _class2; /* -*- coding: utf-8 -*- */

var _mobxReact = __webpack_require__(5);

var _reactRouterDom = __webpack_require__(8);

var _reactMde = __webpack_require__(71);
...
var IssueDraftOptions = (0, _mobxReact.observer)(_class = function (_React$Component) {
		_inherits(IssueDraftOptions, _React$Component);

		function IssueDraftOptions() {
				_classCallCheck(this, IssueDraftOptions);

				return _possibleConstructorReturn(this, (IssueDraftOptions.__proto__ || Object.getPrototypeOf(IssueDraftOptions)).apply(this, arguments));
		}

		_createClass(IssueDraftOptions, [{
				key: 'componentDidMount',
				value: function componentDidMount() {
						...
						return React.createElement(
								...
								React.createElement(
										...
										React.createElement(
												...
												[topLabels, cnt][0].map(function (label, i) {
														...
														return React.createElement(
																...
																active ? React.createElement('i', { className: 'fa fa-check' }) : React.createElement('i', null)
														);
												})
										)
								)
		...
		return IssueDraftOptions;
}(React.Component)) || _class;

var IssueForm = (0, _mobxReact.observer)(_class2 = function (_React$Component2) {
		_inherits(IssueForm, _React$Component2);

		function IssueForm() {
				_classCallCheck(this, IssueForm);

				return _possibleConstructorReturn(this, (IssueForm.__proto__ || Object.getPrototypeOf(IssueForm)).apply(this, arguments));
		}
		...
		_createClass(IssueForm, [{
				...
				value: function form() {
						...
						var invalid = store.form.invalid;
						var userValid = !!store.conf.config.user.user_id;
						return React.createElement(
								'div',
								null,
								React.createElement(
										...
										React.createElement('input', { type: 'text', placeholder: 'Title', required: true,
												className: invalid.title ? 'form-control is-invalid' : 'form-control',
												id: 'issue-title',
												onChange: function onChange(e) {
														store.form.title = e.target.value;
												},
												value: store.form.title, maxLength: 120 }),
										invalid.title ? React.createElement(
												'div',
												{ className: 'invalid-feedback' },
												'Please provide a title for the issue.'
										) : React.createElement('div', { className: 'form-text text-muted' })
								),
								React.createElement(
										'div',
										{ className: 'form-group' },
										React.createElement(_reactMde2.default, { value: store.form.content, id: 'issue-content',
												textAreaProps: {
								...
								React.createElement(
										...
										React.createElement(
												...
												React.createElement(
														'div',
														{ className: 'row' },
														React.createElement('div', { className: 'col-auto mr-auto' }),
														React.createElement(
																'div',
																{ className: 'col-auto' },
																store.form.loading ? React.createElement(
																		'button',
																		...
																		'button',
																		{
																				className: userValid ? "btn btn-primary" : "btn btn-secondary",
																				disabled: !userValid,
				...
				value: function render() {
						var store = this.props.store;
						var userValid = store.conf.userValid;

						return React.createElement(
								'div',
								{ className: 'container issue-form' },
								React.createElement(
										'h2',
										null,
										'New issue'
								...
								React.createElement(
										...
										React.createElement(
												...
												store.form.success ? React.createElement(
														_reactRouterDom.Router,
														this.props,
														React.createElement(_reactRouterDom.Redirect, { from: '/new', to: '/' })
												) : this.form()
										),
										React.createElement(
												'div',
												{ className: 'pure-u-1-3 form-options' },
												store.conf.config.is_admin ? React.createElement(IssueDraftOptions, { store: store }) : React.createElement(
														'div',
														null,
														userValid ? React.createElement('div', null) : React.createElement(
																'div',
																null,
																React.createElement(
																		'button',
...
var _widgets = __webpack_require__(23);
...
var IssuePage = (0, _mobxReact.observer)(_class = function (_React$Component) {
		_inherits(IssuePage, _React$Component);

		function IssuePage() {
				_classCallCheck(this, IssuePage);

				return _possibleConstructorReturn(this, (IssuePage.__proto__ || Object.getPrototypeOf(IssuePage)).apply(this, arguments));
		}
		...
		_createClass(IssuePage, [{
				...
				value: function componentDidMount() {
						...
						var issueId = match.params.issue_id;
						if (!issueId || !store) {
								return;
						}
				...
				value: function render() {
						var _props3 = this.props,
						    store = _props3.store,
						    match = _props3.match;
						var _store$issue = store.issue,
						    loading = _store$issue.loading,
						    err = _store$issue.err,
						    loaded = _store$issue.loaded;

						return React.createElement(
								'div',
								{ className: 'container' },
								'issue_id: ',
								match.params.issue_id,
								React.createElement(
										'div',
										null,
										loading ? React.createElement(_widgets.AniLoading, null) : loaded ? this.thread() : React.createElement(
												'span',
												{ className: '' },
												'...'
										)
...
var _desc, _value, _class, _descriptor, _descriptor2, _descriptor3, _desc2, _value2, _class3, _descriptor4, _descriptor5, _desc3, _value3, _class5, _descriptor6, _desc4, _value4, _class7, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _desc5, _value5, _class9, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _desc6, _value6, _class11, _descriptor16; /* -*- coding: utf-8 -*- */
...
var StoreBase = (_class = function () {
				function StoreBase() {
								...
								_initDefineProp(this, 'loaded', _descriptor3, this);
				}
...
}), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, 'loaded', [_mobx.observable], {
				enumerable: true,
				initializer: function initializer() {
								return false;
				}
})), _class);
var StoreConfig = (_class3 = function (_StoreBase) {
				_inherits(StoreConfig, _StoreBase);
				...
				function StoreConfig() {
								...
								return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = StoreConfig.__proto__ || Object.getPrototypeOf(StoreConfig)).call.apply(_ref, [this].concat(args))), _this), _initDefineProp(_this, 'config', _descriptor4, _this), _initDefineProp(_this, 'loaded', _descriptor5, _this), _temp), _possibleConstructorReturn(_this, _ret);
				}
				...
				return StoreConfig;
}(StoreBase), (_descriptor4 = _applyDecoratedDescriptor(_class3.prototype, 'config', [_mobx.observable], {
				enumerable: true,
				initializer: function initializer() {
								return {};
				}
}), _descriptor5 = _applyDecoratedDescriptor(_class3.prototype, 'loaded', [_mobx.observable], {
				enumerable: true,
				initializer: function initializer() {
								return false;
				}
}), _applyDecoratedDescriptor(_class3.prototype, 'userValid', [_mobx.computed], Object.getOwnPropertyDescriptor(_class3.prototype, 'userValid'), _class3.prototype)), _class3);
var StoreLabels = (_class5 = function (_StoreBase2) {
				_inherits(StoreLabels, _StoreBase2);
				...
				function StoreLabels() {
								...
								_classCallCheck(this, StoreLabels);

								for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
												args[_key2] = arguments[_key2];
								}

								return _ret2 = (_temp2 = (_this2 = _possibleConstructorReturn(this, (_ref2 = StoreLabels.__proto__ || Object.getPrototypeOf(StoreLabels)).call.apply(_ref2, [this].concat(args))), _this2), _initDefineProp(_this2, 'topLabels', _descriptor6, _this2), _temp2), _possibleConstructorReturn(_this2, _ret2);
				}

				_createClass(StoreLabels, [{
								key: 'load',
				...
				return StoreLabels;
}(StoreBase), (_descriptor6 = _applyDecoratedDescriptor(_class5.prototype, 'topLabels', [_mobx.observable], {
				enumerable: true,
				initializer: function initializer() {
								return [];
				}
})), _class5);
var StoreNodeForm = (_class7 = function (_StoreBase3) {
				_inherits(StoreNodeForm, _StoreBase3);

				function StoreNodeForm() {
								var _ref3;

								var _temp3, _this3, _ret3;

								_classCallCheck(this, StoreNodeForm);

								for (var _len3 = arguments.length, args = Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
												args[_key3] = arguments[_key3];
								}

								return _ret3 = (_temp3 = (_this3 = _possibleConstructorReturn(this, (_ref3 = StoreNodeForm.__proto__ || Object.getPrototypeOf(StoreNodeForm)).call.apply(_ref3, [this].concat(args))), _this3), _initDefineProp(_this3, 'content', _descriptor7, _this3), _initDefineProp(_this3, 'labelCnt', _descriptor8, _this3), _initDefineProp(_this3, 'title', _descriptor9, _this3), _initDefineProp(_this3, 'invalid', _descriptor10, _this3), _initDefineProp(_this3, 'success', _descriptor11, _this3), _this3._labelState = {}, _temp3), _possibleConstructorReturn(_this3, _ret3);
				}

				_createClass(StoreNodeForm, [{
								key: 'toggleLabel',
				...
				return StoreNodeForm;
}(StoreBase), (_descriptor7 = _applyDecoratedDescriptor(_class7.prototype, 'content', [_mobx.observable], {
				enumerable: true,
				initializer: function initializer() {
								return { text: '', selection: null };
				}
}), _descriptor8 = _applyDecoratedDescriptor(_class7.prototype, 'labelCnt', [_mobx.observable], {
				enumerable: true,
				initializer: function initializer() {
								return 0;
				}
}), _descriptor9 = _applyDecoratedDescriptor(_class7.prototype, 'title', [_mobx.observable], {
				enumerable: true,
				initializer: function initializer() {
								return '';
				}
}), _descriptor10 = _applyDecoratedDescriptor(_class7.prototype, 'invalid', [_mobx.observable], {
				enumerable: true,
				initializer: function initializer() {
								return {
												title: false,
...
}), _descriptor11 = _applyDecoratedDescriptor(_class7.prototype, 'success', [_mobx.observable], {
				enumerable: true,
				initializer: function initializer() {
								return false;
				}
}), _applyDecoratedDescriptor(_class7.prototype, 'selectedLabels', [_mobx.computed], Object.getOwnPropertyDescriptor(_class7.prototype, 'selectedLabels'), _class7.prototype)), _class7);
var StoreNodes = (_class9 = function (_StoreBase4) {
				_inherits(StoreNodes, _StoreBase4);
				...
				function StoreNodes() {
								...
								_classCallCheck(this, StoreNodes);

								for (var _len4 = arguments.length, args = Array(_len4), _key4 = 0; _key4 < _len4; _key4++) {
												args[_key4] = arguments[_key4];
								}

								return _ret4 = (_temp4 = (_this4 = _possibleConstructorReturn(this, (_ref4 = StoreNodes.__proto__ || Object.getPrototypeOf(StoreNodes)).call.apply(_ref4, [this].concat(args))), _this4), _initDefineProp(_this4, 'nodes', _descriptor12, _this4), _initDefineProp(_this4, 'page', _descriptor13, _this4), _initDefineProp(_this4, 'hasMore', _descriptor14, _this4), _initDefineProp(_this4, 'label', _descriptor15, _this4), _temp4), _possibleConstructorReturn(_this4, _ret4);
				}

				_createClass(StoreNodes, [{
								key: 'reset',
								value: function reset() {
												this.loading = false;
												this.err = '';
				...
				return StoreNodes;
}(StoreBase), (_descriptor12 = _applyDecoratedDescriptor(_class9.prototype, 'nodes', [_mobx.observable], {
				enumerable: true,
				initializer: function initializer() {
								return [];
				}
}), _descriptor13 = _applyDecoratedDescriptor(_class9.prototype, 'page', [_mobx.observable], {
				enumerable: true,
				initializer: function initializer() {
								return 1;
				}
}), _descriptor14 = _applyDecoratedDescriptor(_class9.prototype, 'hasMore', [_mobx.observable], {
				enumerable: true,
				initializer: function initializer() {
								return false;
				}
}), _descriptor15 = _applyDecoratedDescriptor(_class9.prototype, 'label', [_mobx.observable], {
				enumerable: true,
				initializer: function initializer() {
								return null;
				}
})), _class9);
var StoreIssue = (_class11 = function (_StoreBase5) {
				_inherits(StoreIssue, _StoreBase5);
				...
				function StoreIssue() {
								...
								_classCallCheck(this, StoreIssue);

								for (var _len5 = arguments.length, args = Array(_len5), _key5 = 0; _key5 < _len5; _key5++) {
												args[_key5] = arguments[_key5];
								}

								return _ret5 = (_temp5 = (_this5 = _possibleConstructorReturn(this, (_ref5 = StoreIssue.__proto__ || Object.getPrototypeOf(StoreIssue)).call.apply(_ref5, [this].concat(args))), _this5), _initDefineProp(_this5, 'nodes', _descriptor16, _this5), _temp5), _possibleConstructorReturn(_this5, _ret5);
				}

				_createClass(StoreIssue, [{
								key: 'reset',
								value: function reset() {
												_get(StoreIssue.prototype.__proto__ || Object.getPrototypeOf(StoreIssue.prototype), 'reset', this).call(this);
												this.nodes = [];
								}
				}, {
								key: 'load',
								value: function load(issueId) {
												console.info('load(' + issueId + ')');
												_get(StoreIssue.prototype.__proto__ || Object.getPrototypeOf(StoreIssue.prototype), 'reset', this).call(this);
												this.loading = true;
												var url = '/issues/nodes/issue/' + issueId + '.json';
												fetch(url, {
																method: 'POST',
																credentials: 'include'
												}).then(function (r) {
				...
				return StoreIssue;
}(StoreBase), (_descriptor16 = _applyDecoratedDescriptor(_class11.prototype, 'nodes', [_mobx.observable], {
				enumerable: true,
				initializer: function initializer() {
								return [];
				}
...
var StoreIssues = function (_StoreBase6) {
				_inherits(StoreIssues, _StoreBase6);
				...
				function StoreIssues() {
								...
								_classCallCheck(this, StoreIssues);

								for (var _len6 = arguments.length, args = Array(_len6), _key6 = 0; _key6 < _len6; _key6++) {
												args[_key6] = arguments[_key6];
								}

								return _ret6 = (_temp6 = (_this6 = _possibleConstructorReturn(this, (_ref6 = StoreIssues.__proto__ || Object.getPrototypeOf(StoreIssues)).call.apply(_ref6, [this].concat(args))), _this6), _this6.conf = new StoreConfig(), _this6.labels = new StoreLabels(), _this6.list = new StoreNodes(), _this6.form = new StoreNodeForm(), _this6.issue = new StoreIssue(), _temp6), _possibleConstructorReturn(_this6, _ret6);
				}

				return StoreIssues;
}(StoreBase);

exports.default = StoreIssues;
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./issue.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./issue.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./widgets.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./widgets.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var _frontPage = __webpack_require__(37);

var _frontPage2 = _interopRequireDefault(_frontPage);

var _issueForm = __webpack_require__(38);

var _issueForm2 = _interopRequireDefault(_issueForm);

var _issuePage = __webpack_require__(39);
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* -*- coding: utf-8 -*- */

var APP_MOUNT_POINT = "/issues/app";

var IssuesApp = function (_React$Component) {
	_inherits(IssuesApp, _React$Component);

	function IssuesApp() {
		_classCallCheck(this, IssuesApp);

		return _possibleConstructorReturn(this, (IssuesApp.__proto__ || Object.getPrototypeOf(IssuesApp)).apply(this, arguments));
	}

	_createClass(IssuesApp, [{
		key: 'render',
		value: function render() {
			var store = this.props.store;
			...
			return React.createElement(
				...
				React.createElement(
					...
					null,
					React.createElement(_reactRouterDom.Route, { path: '/new',
						component: function component(m) {
							return React.createElement(_issueForm2.default, _extends({}, m, { store: store }));
						} }),
					React.createElement(_reactRouterDom.Route, { path: '/issue/:issue_id',
						component: function component(m) {
							return React.createElement(_issuePage2.default, _extends({}, m, { store: store }));
						} }),
					React.createElement(_reactRouterDom.Route, { path: '/label/:label/page/:page',
						component: function component(m) {
							return React.createElement(_frontPage2.default, _extends({}, m, { store: store }));
						} }),
					React.createElement(_reactRouterDom.Route, { path: '/label/:label',
						component: function component(m) {
							return React.createElement(_frontPage2.default, _extends({}, m, { store: store,
								labelId: m.match.params.label }));
						} }),
					React.createElement(_reactRouterDom.Route, { path: '/page/:page',
						component: function component(m) {
							return React.createElement(_frontPage2.default, _extends({}, m, { store: store }));
						} }),
...
var Loader = (0, _mobxReact.observer)(_class = function (_React$Component2) {
		...
		value: function render() {
			...
			if (store.conf.loading) {
				return React.createElement(
					'div',
					{ className: 'container' },
					React.createElement(_widgets.AniLoading, null)
				);
			...
			return React.createElement(IssuesApp, this.props);
		}
	}]);
...
ReactDOM.render(React.createElement(Loader, { store: store }), document.getElementById('issues-app'));
...
var _issueNode = __webpack_require__(45);

var _issueNode2 = _interopRequireDefault(_issueNode);
...
var IssueNodeList = (0, _mobxReact.observer)(_class = function (_React$Component) {
	_inherits(IssueNodeList, _React$Component);

	function IssueNodeList() {
		_classCallCheck(this, IssueNodeList);

		return _possibleConstructorReturn(this, (IssueNodeList.__proto__ || Object.getPrototypeOf(IssueNodeList)).apply(this, arguments));
	}

	_createClass(IssueNodeList, [{
		key: 'render',
		value: function render() {
			var store = this.props.store;
			var _store$list = store.list,
			    loading = _store$list.loading,
			    err = _store$list.err;
			var _store$list2 = store.list,
			    nodes = _store$list2.nodes,
			    page = _store$list2.page,
			    hasMore = _store$list2.hasMore,
			    label = _store$list2.label;
			...
			return React.createElement(
				...
				React.createElement(
					...
					nodes.length <= 0 ? React.createElement(
						'div',
						null,
						'no issues.'
					) : React.createElement('div', null),
					nodes.map(function (node, i) {
						return React.createElement(_issueNode2.default, {
							store: store,
							node: node,
							key: i });
					})
...
var IssueNode = function (_React$Component) {
		_inherits(IssueNode, _React$Component);

		function IssueNode() {
				_classCallCheck(this, IssueNode);

				return _possibleConstructorReturn(this, (IssueNode.__proto__ || Object.getPrototypeOf(IssueNode)).apply(this, arguments));
		}

		_createClass(IssueNode, [{
				key: "componentDidMount",
				value: function componentDidMount() {
						// --
				}
				...
				value: function render() {
						...
						var avatarUrl = "/users/user/" + node.created_user_id + "/avatar.png";
						var createdAt = new Date(node.created_at);
						return React.createElement(
								"li",
								{ className: "issues-item issues-sec" },
								React.createElement(
										"p",
										{ className: "issues-author" },
										React.createElement(
												"a",
												{ href: "#" },
												React.createElement("img", { src: avatarUrl, alt: "avatar", className: "avatar img-circle img-responsive" }),
												React.createElement(
														"span",
														{ className: "author" },
														node.created_user_name
												)
										),
										React.createElement(
												"span",
...
var LabelLink = function LabelLink(props) {
				return React.createElement(
								...
								React.createElement(_reactRouterDom.Route, { path: props.to, children: function children(_ref) {
...
var LabelsBar = (0, _mobxReact.observer)(_class = function (_React$Component) {
				_inherits(LabelsBar, _React$Component);

				function LabelsBar() {
								_classCallCheck(this, LabelsBar);

								return _possibleConstructorReturn(this, (LabelsBar.__proto__ || Object.getPrototypeOf(LabelsBar)).apply(this, arguments));
				}
				...
				_createClass(LabelsBar, [{
								...
								value: function render() {
												...
												return React.createElement(
																...
																React.createElement(
																				'section',
																				{ className: 'pure-g issues-labels' },
																				React.createElement(
																								'div',
																								{ className: 'pure-u-1 issues-labels-inner clearfix container' },
																								React.createElement(
																												'ul',
																												{ className: 'label-list list-inline pull-left' },
																												topLabels.map(function (label, i) {
																																return React.createElement(LabelLink, { label: label, key: i,
																								...
																								React.createElement(
																												'div',
																												{ className: 'pull-right issues-edit' },
																												React.createElement(
																																_reactRouterDom.Link,
																																{ to: '/new', className: 'edit-link pull-right' },
																																React.createElement('i', { className: 'fa fa-pencil' })
																												),
																												React.createElement(
																																'form',
																																{ action: './', className: 'search-box pull-right' },
																																React.createElement(
																																				'a',
																																				{ href: '#', className: 'search-icon' },
																																				React.createElement('i', { className: 'fa fa-search' })
																																),
																																React.createElement('input', { type: 'text', className: 'search-input', placeholder: 'Search Issues' })
																												),
...
// module
exports.push([module.i, "/* -*- coding: utf-8 -*- */\r\n\r\n.form-options\r\n{\r\n    box-sizing: border-box;\r\n    -webkit-box-sizing: border-box;\r\n    padding: 0.5em 1em;\r\n}\r\n", ""]);
...
var React = __webpack_require__(0);
var ReactMdeSelectionHelper_1 = __webpack_require__(17);
var ReactMdeToolbar_1 = __webpack_require__(30);
var ReactMdeTextArea_1 = __webpack_require__(29);
var ReactMdePreview_1 = __webpack_require__(28);
...
var React = __webpack_require__(0);
var ReactMdeTextHelper_1 = __webpack_require__(18);
var ReactMdeCommandHelper_1 = __webpack_require__(31);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var HeaderItemDropdownItem_1 = __webpack_require__(69);
...
Object.defineProperty(exports, "__esModule", { value: true });
var ReactMdeCommands = __webpack_require__(65);
exports.ReactMdeCommands = ReactMdeCommands;
var ReactMdeCommandHelper = __webpack_require__(31);
exports.ReactMdeCommandHelper = ReactMdeCommandHelper;
var ReactMdeSelectionHelper = __webpack_require__(17);
exports.ReactMdeSelectionHelper = ReactMdeSelectionHelper;
var ReactMdeTextHelper = __webpack_require__(18);
exports.ReactMdeTextHelper = ReactMdeTextHelper;
var ReactMdeTypes = __webpack_require__(72);
...
var ReactMde_1 = __webpack_require__(64);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../css-loader/index.js!./react-mde-all.css", function() {
			var newContent = require("!!../../../../css-loader/index.js!./react-mde-all.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
