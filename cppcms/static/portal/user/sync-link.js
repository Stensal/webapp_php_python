...
var _desc, _value, _class, _descriptor, _descriptor2, _descriptor3; /* -*- coding: utf-8 -*- */
...
var StoreUserSync = (_class = function () {
				function StoreUserSync() {
								_classCallCheck(this, StoreUserSync);

								_initDefineProp(this, 'loading', _descriptor, this);

								_initDefineProp(this, 'err', _descriptor2, this);

								_initDefineProp(this, 'success', _descriptor3, this);
				}

				_createClass(StoreUserSync, [{
								key: 'syncAll',
...
}), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, 'success', [_mobx.observable], {
				enumerable: true,
				initializer: function initializer() {
								return false;
				}
...
var StoreUser = function StoreUser() {
				_classCallCheck(this, StoreUser);

				this.sync = new StoreUserSync();
};
...
var SyncLink = (0, _mobxReact.observer)(_class = function (_React$Component) {
				_inherits(SyncLink, _React$Component);

				function SyncLink() {
								_classCallCheck(this, SyncLink);

								return _possibleConstructorReturn(this, (SyncLink.__proto__ || Object.getPrototypeOf(SyncLink)).apply(this, arguments));
				}

				_createClass(SyncLink, [{
								key: 'render',
								value: function render() {
												...
												return React.createElement(
																...
																React.createElement(
																				...
																				store.sync.loading ? React.createElement(
																								'span',
																								null,
																								'loading...'
																				) : React.createElement(
																								...
																								null,
																								'Sync',
																								store.sync.err ? React.createElement(
																												'span',
																												{ className: 'err' },
																												'!'
																								) : null
...
ReactDOM.render(React.createElement(SyncLink, { store: store }), span);
